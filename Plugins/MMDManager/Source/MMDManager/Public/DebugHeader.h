...
/* 将信息打印到Log                                                        */
/************************************************************************/
void PrintUELog(const FString &Message)
{
...
/************************************************************************/
EAppReturnType::Type ShowMesDialog(EAppMsgType::Type MsgType, const FString& Message, bool bShowMesAsWarning = true, FText MesTitle = FText::FromString(TEXT("Warning")))
{
